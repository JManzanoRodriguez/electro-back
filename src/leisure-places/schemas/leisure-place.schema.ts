...
export type LeisurePlaceDocument = LeisurePlace & Document;

@Schema()
export class LeisurePlace {
  @Prop([String])
  photos: string[];
...
export const LeisurePlaceSchema = SchemaFactory.createForClass(LeisurePlace);